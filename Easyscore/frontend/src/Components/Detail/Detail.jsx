        ...
        <div className="container mx-auto my-20 p-5 bg-white rounded-lg shadow-lg">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <p className="text-gray-700 text-lg mb-4"><strong>Ciudad:</strong> {productSelected.ubicacion.ciudad}</p>
                    <p className="text-gray-700 text-lg mb-4"><strong>Dirección:</strong> {productSelected.ubicacion.direccion}</p>
